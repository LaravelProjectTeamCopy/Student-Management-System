...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.master','data' => ['title' => 'Financial History']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Financial History']); ?>
    
     <?php $__env->slot('breadcrumb', null, []); ?> 
        <?php if (isset($component)) { $__componentOriginale19f62b34dfe0bfdf95075badcb45bc2 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale19f62b34dfe0bfdf95075badcb45bc2 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['links' => ['Dashboard' => '/welcome', 'Financials' => route('financials.index')],'current' => 'History']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['links' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Dashboard' => '/welcome', 'Financials' => route('financials.index')]),'current' => 'History']); ?>
...
<?php endif; ?>
    ...
    <div class="bg-white dark:bg-slate-900 p-4 rounded-xl border border-slate-200 dark:border-slate-800 flex flex-wrap gap-3 mb-6 items-center">
        ...
        <form action="<?php echo e(route('financials.studenthistory')); ?>" method="GET" class="flex flex-wrap gap-3">
        ...
        <?php if(request('semester')): ?>
            <form action="<?php echo e(route('financials.deleteallstudenthistory', ['semester_end' => request('semester')])); ?>" method="POST"
                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 rounded-md bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-medium">
                                <?php echo e($history->student->major); ?>
                        ...
                        <td class="px-6 py-4 text-sm font-medium text-slate-700 dark:text-slate-300">
                            $<?php echo e(number_format($history->total_fees, 2)); ?>

                        </td>

                        
                        <td class="px-6 py-4 text-sm font-medium text-emerald-600">
                            $<?php echo e(number_format($history->amount_paid, 2)); ?>

                        </td>

                        
                        <td class="px-6 py-4 text-sm font-medium <?php echo e($history->balance_remaining > 0 ? 'text-red-500' : 'text-emerald-600'); ?>">
                            $<?php echo e(number_format($history->balance_remaining, 2)); ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            <?php elseif($history->payment_status === 'Partial'): ?>
                            ...
                            <?php elseif($history->payment_status === 'Unpaid'): ?>
...
<?php endif; ?><?php /**PATH D:\xampp\htdocs\proweb\Student-Management-System\resources\views/financials/all-students-hisitory.blade.php ENDPATH**/ ?>