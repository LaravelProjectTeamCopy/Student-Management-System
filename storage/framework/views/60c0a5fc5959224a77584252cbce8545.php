...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.master','data' => ['title' => ''.e($student->name).' Academic Record']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => ''.e($student->name).' Academic Record']); ?>
...
<?php endif; ?>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 overflow-hidden shadow-sm">
        <div class="p-5 border-b border-slate-100 dark:border-slate-800 flex items-center gap-2">
            ...
            <h3 class="text-base font-bold text-slate-900 dark:text-white">Subject Scores <?php echo e($currentSem); ?>, <?php echo e($currentYear); ?></h3>
        </div>
                        ...
                        <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition-all">
                            <td class="px-6 py-4">
                                <div class="flex flex-col">
                                    <span class="text-sm font-semibold text-slate-900 dark:text-white"><?php echo e($score->subject->name ?? '—'); ?></span>
                                    <span class="text-xs text-slate-400"><?php echo e($score->subject->subject_code ?? ''); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-center text-sm font-bold <?php echo e($scoreColor); ?>"><?php echo e($score->attendance ?? '—'); ?></td>
                            <td class="px-6 py-4 text-center text-sm font-bold <?php echo e($scoreColor); ?>"><?php echo e($score->quiz ?? '—'); ?></td>
                            <td class="px-6 py-4 text-center text-sm font-bold <?php echo e($scoreColor); ?>"><?php echo e($score->midterm ?? '—'); ?></td>
                            <td class="px-6 py-4 text-center text-sm font-bold <?php echo e($scoreColor); ?>"><?php echo e($score->final_exam ?? '—'); ?></td>
...
<?php endif; ?>
<?php /**PATH D:\Student-Management-System\resources\views/academicrecords/show.blade.php ENDPATH**/ ?>