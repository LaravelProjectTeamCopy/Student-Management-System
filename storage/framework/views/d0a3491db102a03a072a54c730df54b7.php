...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.breadcrumb','data' => ['links' => ['Dashboard' => '/welcome'],'current' => 'Academic Scores']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['links' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['Dashboard' => '/welcome']),'current' => 'Academic Scores']); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div class="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 hover:shadow-md transition-all">
            <div class="flex justify-between items-start mb-2">
                <p class="text-xs font-bold uppercase tracking-widest text-slate-500"><?php echo e($stat['label']); ?></p>
                <span class="material-symbols-outlined <?php echo e($stat['color']); ?> text-xl opacity-20"><?php echo e($stat['icon']); ?></span>
            </div>
...
<?php endif; ?><?php /**PATH D:\University\University Year 2\Backend Development with Api\Laravel\Student-Management-System\resources\views/academicrecords/show.blade.php ENDPATH**/ ?>