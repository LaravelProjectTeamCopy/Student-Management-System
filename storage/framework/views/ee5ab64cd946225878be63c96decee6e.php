                ...
                <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <p class="mt-1 font-medium text-slate-900 dark:text-slate-100">
                            <?php echo e($student->date_of_birth ? \Carbon\Carbon::parse($student->date_of_birth)->format('M d, Y') : '—'); ?>
...
<?php endif; ?><?php /**PATH D:\University\University Year 2\Backend Development with Api\Laravel\Student-Management-System\resources\views/students/show.blade.php ENDPATH**/ ?>