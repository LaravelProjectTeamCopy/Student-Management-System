<x-layouts.master title="Import Students">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div class="px-8 py-5 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 flex items-center justify-end gap-4">
                <a href="{{ route('students.index') }}" class="px-6 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    Cancel
                </a>
                <button
                    type="submit"
    ...
    {{-- JS: show file name after selection --}}
    {{-- JS: show file name after selection --}}
    <script>
