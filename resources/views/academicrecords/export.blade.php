<x-layouts.master title="Export Academic Scores">

    <x-slot name="breadcrumb">
        <x-breadcrumb :links="['Dashboard' => '/dashboard', 'Academic Scores' => route('academicrecords.index')]" current="Export" />
    </x-slot>
    ...
    <div class="flex flex-1 flex-col items-center justify-center">
        ...
        <div class="w-full max-w-2xl overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-sm border border-slate-200 dark:border-slate-800">
            <div class="p-12 flex flex-col items-center text-center">
                ...
                {{-- Export Button --}}
                <a
                    href="{{ route('academicrecords.exportcsv') }}"
