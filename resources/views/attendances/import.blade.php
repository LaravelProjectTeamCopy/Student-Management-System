<x-layouts.master title="Import Attendance">
    
    <x-slot name="breadcrumb">
        <x-breadcrumb :links="['Dashboard' => '/dashboard', 'Attendances' => route('attendances.index')]" current="Import" />
    </x-slot>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="text-slate-500 dark:text-slate-400 mt-2">
                Manage your attendance records by importing from a CSV file.
            </p>
        </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden">
            ...
            <div class="p-8">
                ...
                {{-- Upload Form --}}
                <form action="{{ route('attendances.import') }}" method="POST" enctype="multipart/form-data" id="importForm">
                    @csrf
            ...
            <div class="px-8 py-5 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 flex items-center justify-end gap-4">
                <a href="{{ route('attendances.index') }}" class="px-6 py-2 text-sm font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    Cancel
                </a>
                <button
                    type="submit"
